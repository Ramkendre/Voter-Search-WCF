<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ControlChart_Final.aspx.cs" Inherits="LatestVoterSearch.Chart.ControlChart_Final" MasterPageFile="~/Master/MainMaster.Master"%>
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <asp:Button ID="btnSubmitFinal" runat="server" Text="Submit" CssClass="btn btn-success" OnClick="btnSubmitFinal_Click"/>
